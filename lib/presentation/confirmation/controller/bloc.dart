...
import 'package:coffee_wonders/model/country_model.dart';
import 'package:coffee_wonders/presentation/confirmation/controller/states.dart';
...
class ConfirmationBloc extends Cubit<ConfirmationStates> {
  ...
  void getStates({required int id}) {
    ...
    DioHelper.getData(
            path: ApiConstant.statePath(id: id),
            token: CacheHelper.getData(key: SharedKey.token))
        .then((value) {
